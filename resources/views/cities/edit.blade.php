                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('cities.update', $city) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" value="{{ $city->title }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        <div class="mb-4">
                            ...
                            <div id="matchers-container" class="flex flex-wrap border border-gray-300 rounded-md p-2">
                                @foreach($city->matchers as $matcher)
                            ...
                            <input type="hidden" name="matchers" id="matchers" value="{{ implode(',', $city->matchers) }}">
                        </div>
                        <div>
