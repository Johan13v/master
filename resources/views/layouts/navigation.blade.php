    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('revenue-streams.index')" :active="request()->routeIs('revenue-streams.index')">
                        {{ __('Inkomsten bronnen') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('commissions.index')" :active="request()->routeIs('commissions.index')">
                        {{ __('Commissies') }}
                    </x-nav-link>
                </div>
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                <!-- Dropdown for Revenue Streams -->
                    @php
                        $revenueStreams = \App\Models\RevenueStream::all();
                    @endphp
                    <div class="relative">
                        <button class="text-gray-500 hover:text-gray-700 focus:outline-none">
                            Imports
                            <svg class="ml-1 h-5 w-5 inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <div class="absolute hidden mt-2 w-48 bg-white border rounded shadow-md">
                            ...
                            <a href="{{ route('tradetracker.sync') }}" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">TradeTracker Sync</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var dropdownButton = document.querySelector('nav button');
